...
export default class Rolelist extends Component {
  constructor() {
    ...
    this.state = {
      data: [],
      url: "https://manraj-ors-1.onrender.com/role"
    }
  }
    ...
    return (
      <>
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          <h1 style={{ textAlign: "center", fontSize: "80px" }}>List of Role</h1>
                ...
                this.state?.data && this.state.data.map((ele, i) => {
                  return (
                    <tr key={ele.id} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                      ...
                      <th scope="row" className="px-1 py-4 font-medium text-red-500 whitespace-wrap dark:text-red">
